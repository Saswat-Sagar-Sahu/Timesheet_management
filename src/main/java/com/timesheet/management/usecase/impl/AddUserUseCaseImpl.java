...
public class AddUserUseCaseImpl implements AddUserUseCase {
    ...
    public AddUserResponse execute(AddUserRequest request) {
        if (request == null || request.getEmpId() == null || request.getName() == null || request.getUsername() == null || request.getRole() == null) {
            return AddUserResponse.builder()
                    .status(false)
                    .message("Invalid request: empId, name, username and role are required")
